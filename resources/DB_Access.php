<?php
	...
	class DB_Access {
		...
		public function insertActorExperience($ref = 0, $data = []){
			$query = "INSERT INTO `beta_actor_experience`(`StashActorExperience_actor_ref`, `StashActorExperience_title`, `StashActorExperience_blurb`, `StashActorExperience_role`, `StashActorExperience_start_time`, `StashActorExperience_end_time`, `StashActorExperience_link`, `StashActorExperience_time`, `StashActorExperience_verify`, `StashActorExperience_status`) 
				VALUES (
					'{$ref}',
					'".$data['title']."',
					'".$data['blurb']."',
