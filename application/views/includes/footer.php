        ...
        <div class="footer-above">
            <div class="container">
                <div class="row">
                    ...
                    <div class="footer-col col-md-6 col-sm-6 col-xs-12 minlrpadding">
                        <div class="col-md-6 col-xs-6 nolrpadding">
                            <ul style="list-style-type:none;margin-top:15px;padding:0px; text-align:left;">
                                ...
                                <li class="footer-items"><i class="fa fa-user-plus" aria-hidden="true" style="font-size:12px;width:12px;"></i><a href="<?= base_url() ?>home/register/actor"><span style="font-family:Raleway;font-size:13px;margin-left:5px;">Actor</span></a></li>
