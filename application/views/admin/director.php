                    ...
                    <div>
                        ...
                        <div class="ibox-content profile-content">
                            ...
                            <div class="user-button">
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="<?= base_url() ?>admin/compose_mail/<?= urldecode($profile['StashDirector_email']) ?>/" class="btn btn-primary btn-sm btn-block"><i class="fa fa-envelope"></i> Send Message</a>
                                    </div>
                                    <!-- IF Have Permission. -->
                                    <!-- <div class="col-md-6">
