                    ...
                    <?php
                      if(count($project)){
                          if( $response == 0 ){
                            ...
                            echo "<p id='res-ques'><hr>Are you coming to the audition ?</p><p id='res-message'><br> You have selected <span class='label label-{$l}'>{$a}</span>. You can change your choice anytime. </p>";
                          }
                    ?>
                    <h3>Response</h3>
                    <hr>
