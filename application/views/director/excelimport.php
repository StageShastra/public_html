...
<hr />
            ...
            <div>  
              ...
              <div class="col-lg-3"><select class="form-control firstcolor" id="columns"  name="columns" onchange="revealColumns(this);notRed(this)"> 
            ...
            <label style="font-size:1.5rem;"> Now tell us which column contains which information: </label>
              <table>
                ...
                <tr>
                  <td><select class="form-control firstcolor hiddenoption" id="col1" name="col1" onchange="notRed(this)">
                  ...
                  <td><select class="form-control firstcolor hiddenoption" id="col2" name="col2" onchange="notRed(this)"">
                    <option selected="selected"  value="empty"> Select One </option>
                    <option>Name</option>
                    <option>Sex</option>
                    <option>Age</option>
                  ...
                  <td><select class="form-control firstcolor hiddenoption" id="col3" name="col3" onchange="notRed(this)">
                    <option selected="selected"  value="empty"> Select One </option>
                    <option>Name</option>
                    <option>Sex</option>
                    <option>Age</option>
                  ...
                  <td><select class="form-control firstcolor hiddenoption" id="col4" name="col4" onchange="notRed(this)">
                    <option selected="selected"  value="empty"> Select One </option>
                    <option>Name</option>
                    <option>Sex</option>
                    <option>Age</option>
                  ...
                  <td><select class="form-control firstcolor hiddenoption" id="col5" name="col5" onchange="notRed(this)">
                    <option selected="selected"  value="empty"> Select One </option>
                    <option>Name</option>
                    <option>Sex</option>
                    <option>Age</option>
                  ...
                  <td><select class="form-control firstcolor hiddenoption" id="col6" name="col6" onchange="notRed(this)">
                    <option selected="selected"  value="empty"> Select One </option>
                    <option>Name</option>
                    <option>Sex</option>
                    <option>Age</option>
                  ...
                  <td><select class="form-control firstcolor hiddenoption" id="col7" name="col7" onchange="notRed(this)">
                    <option selected="selected"  value="empty"> Select One </option>
                    <option>Name</option>
                    <option>Sex</option>
                    <option>Age</option>
...
<hr />
          ...
          <br>
          <input type="file" id="excelFile" disabled="true" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"  onchange="validateForm()"/>
          <br>
