                        ...
                        <div class="content-box">
                            ...
                            <div class="left_aligned">
                                <div class="expandButton">
                                    <span id="minus1" data-hide-id="#minus1,#basic1" data-unhide-id="#plus1" class="plus toggleEdit hidden">o<span class="subtext black"> Public profile with Photos and Videos. </span></span><span class="plus toggleEdit" id="plus1" data-hide-id="#plus1" data-unhide-id="#basic1,#minus1" >+
                                    <span class="subtext black"> Public profile with Photos and Videos. </span></span>
                                ...
                                <div class="expandButton">
                                    <span id="minus2" data-hide-id="#minus2,#basic2" data-unhide-id="#plus2" class="plus toggleEdit hidden">o<span class="subtext black"> Unlimited Casting Director Invitations. </span></span>
                                    <span class="plus toggleEdit" id="plus2" data-hide-id="#plus2" data-unhide-id="#basic2,#minus2" >+
                                    <span class="subtext black"> Unlimited Casting Director Invitations. </span></span>
                    ...
                    <div class="col-lg-6 col-xs-12 col-md-6 col-sm-12 topmargin35">
                        <div class="content-box">
                            ...
                            <div class="left_aligned">
                                ...
                                <div class="expandButton">
                                    <span id="minus4" data-hide-id="#minus4,#pro2" data-unhide-id="#plus4" class="plus toggleEdit hidden">o<span class="button_text black"> <b>Access to targeted audition notices.</b> </span></span>
                                    <span class="plus toggleEdit" id="plus4" data-hide-id="#plus4" data-unhide-id="#pro2,#minus4" >+
                                    <span class="button_text black"> <b>Access to targeted audition notices.</b> </span></span>
