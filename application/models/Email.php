<?php
	class Email extends CI_Model {
		...
		public function profileCompletion($director){
			$mail = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" style="margin-top:0;margin-bottom:0;margin-right:0;margin-left:0;padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;" ><head></head><body style="font-family: &quot;Lucida Sans Unicode&quot;,&quot;Lucida Grande&quot;;font-size: 15px;"><div class="outer" style="padding: 50px;background: #F05759;background-image: linear-gradient(29deg, rgb(226, 162, 17) 3%, rgba(216, 115, 27, 0.86) 20%, rgba(195, 15, 76, 0.86) 100%, rgb(255, 0, 35) 10%);"><div class="container" style="border-radius: 15px;padding: 10px 25px;background: white;"><center><img src="http://catiko.com/assets/img/email_logo.png" style="display: block;max-width: 100%;height: auto;"></center><hr style="background: #ddd;"><span class="salutation" style="font-size: 22px;color: #777;">Congratulations!</span><br>Your Castiko profile is now visible to the casting directors at <b>.'$director.'</b>.<br><b> But we noticed that your profile is still incomplete.</b><center><img src="http://castiko.com/assets/img/complete_profile_emailer.png" style="display: block;max-width: 100%;height: auto;"></center><br><b>For Casting Directors to call you for auditions, adding your videos, photographs and experiences is crucial!</b><br>A complete profile will let you fully experience the power of Castiko.<br><center><img src="http://catiko.com/assets/img/macbook_actor_register.png" style="display: block;max-width: 100%;height: auto;"><br></center><div class="row" style="display: table;float: none;"><div class="sm-4" style="width: 33.33%;float: left;"><center><img src="http://catiko.com/assets/img/crosshair.png" style="display: block;max-width: 100%;height: auto;"></center><br><center> <span class="sub_heading"> GET NOTICED </span></center><br><div class="small_text" style="font-size: 14px;color: #4a4a4a;padding: 5px 10px;">When they are looking for talent, <b> the first thing a Casting Director wants to see is photos and videos of you</b></div></div><div class="sm-4" style="width: 33.33%;float: left;"><center><img src="http://catiko.com/assets/img/search.png" style="margin-bottom: 25px;display: block;max-width: 100%;height: auto;"></center><br><center> <span class="sub_heading"> BE SEARCHABLE </span></center><br><div class="small_text" style="font-size: 14px;color: #4a4a4a;padding: 5px 10px;">If anyone looks you up on Google, your Castiko profile will show up as one of the top results.</div></div><div class="sm-4" style="width: 33.33%;float: left;"><center><img src="http://catiko.com/assets/img/share.png" style="margin-bottom: 26px;display: block;max-width: 100%;height: auto;"></center><br><center> <span class="sub_heading"> SHARE UNIQUELY </span></center><br><div class="small_text" style="font-size: 14px;color: #4a4a4a;padding: 5px 10px;">Your profile has a unique shareable link which you can send to anyone you want to. All changes you make are live instantly.</div></div></div><br><br><center><a href="http://castiko.com/actor?referer=completion_mail"><button class="btn" style="position: relative;bottom: -30px;border: 3px solid #F05759;border-radius: 40px;font-size: 24px;color: #000;background-color: #fff;transition: all .3s ease-in-out;margin-right: 10px;padding: 5px 20px;text-transform: uppercase;">Complete Your Profile</button></a></center></div><div class="footer"><br><center><span class="footer_small" style="font-size: 12px;color: white;">Questions or comments? Write to us at connect@castiko.com<br>We usually reply within 24 hours<p class="footer_copyright" style="font-size: 10px;color: rgba(255,255,255,0.7);">Copyright © 2016 Castiko, All rights reserved.<br>C-411, Kailas Business Park, Vikhroli, Mumbai-79</p></span></center></div></div></body></html>';
			return $mail;
		}
