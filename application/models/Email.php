<?php
	class Email extends CI_Model {
		...
		public function sendInvitationToNotInDB($msg = '', $to = '', $project = 0, $rand = '', $sub = "Invitation "){
			...
			$message = $message.'<img src='"http://www.google-analytics.com/collect?v=1&tid=UA-81419637-1&cid='.$to.'&t=event&ec=email&ea=open&el=recipient_id&cs=invitation&cm=email&cn=Campaign_Name'"></img>"";
			$message = preg_replace('~\\\r\\\n~',"<br>", $message);
			$this->email->clear();
			$this->email->set_newline("\n");
			$this->email->from("no-reply@castiko.com", 'Castiko');
